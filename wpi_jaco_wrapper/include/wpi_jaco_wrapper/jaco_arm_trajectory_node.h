...
////FORCE CONTROL////
#include <wpi_jaco_msgs/SetForceControl.h>
#include <wpi_jaco_msgs/ConfigCartesianInertiaDamping.h>
...
private:
    ...
    */
    ...
    /**
     * \brief Call back when force control service is invoked by a client
     * @param req SetForceControl service -> bool forceControl
     * @param res SetForceControl service -> bool status
     */
    bool setForceCallback(wpi_jaco_msgs::SetForceControl::Request &req, wpi_jaco_msgs::SetForceControl::Response &res);
    /**
     * \brief sets the inertia and damping parameters for the arm
     * @param req SetForceControl service -> geometry_msgs/Twist
     * @param res SetForceControl service -> bool
     */
    bool configCartesianInertiaDampingCallback(wpi_jaco_msgs::ConfigCartesianInertiaDamping::Request &req,
                                                                        wpi_jaco_msgs::ConfigCartesianInertiaDamping::Response &res);//,ros::NodeHandle &n);
    ...
    //force control
    ros::ServiceServer setForceControlServer; //service server for force control
    ros::ServiceServer configCartesianInertiaDampingServer;
    // Actionlib
